...
public class MainActivity extends AppCompatActivity implements
        OnClickListener, VolumeAdjustListener ,OnItemClickListener, OnGetSearchInfoListener, OnGetVkeyListener, OnGetLrcInfoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchEdt = (EditText) findViewById(R.id.edit_Music_name);
        initList();
...
//        lv_music.setOnItemClickListener(adapter);
    ...
    public void disPlaySearchMusicList(){
        mMusicInfoAdapter = new MusicInfoAdapter(this, R.layout.activity_music_info, mQqMusicInfoList);
